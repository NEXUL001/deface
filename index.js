...
const apikey = "ptlc_OiWwAhngksLCHXZOdCdgyWnhBQcsrVJNxV2StqKF3o8";
const capikey = "ptla_8ZdZORUznI1nQpBuPjNC4PYd5qJcZD8GHnrl3Adl7ht";
const domain = "https://lenzzofficial.serverku.biz.id";
const nestid = "5";
const egg = "15";
const loc = "1";
